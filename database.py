...
DISEASE_DATA = [
    ...
    ("Tomato Target Spot",          "Tomato", "Small brown spots with concentric rings",                                  "Medium"),
    ("Tomato Septoria Leaf Spot",   "Tomato", "Small circular spots with dark margins",                                   "Medium"),
    ("Tomato Mosaic Virus", "Tomato", "Mottled leaves with light and dark green patches",                                 "High"),
    ("Tomato Spider Mites", "Tomato", "Tiny yellow spots and webbing on leaves",                                          "Medium"),
    ("Tomato Yellow Leaf Curl Virus", "Tomato", "Leaf curling and yellowing due to virus",                                "High"),
]
...
TREATMENT_DATA = [
    ...
    "Tomato Target Spot",
    "Chlorothalonil 75% WP",
    "2g per litre. Spray every 7–10 days.",
    "Neem Oil 3%",
    "30ml per litre. Spray every 5 days.",
    "Effective against fungal leaf spots.",
    "Requires repeated spraying in humid weather.",
...
(
    ...
    "Mancozeb 75% WP",
    "2.5g per litre. Spray every 7 days.",
    "Neem Oil",
    "30ml per litre. Spray regularly.",
    "Prevents rapid spread.",
    "Needs early detection for effectiveness.",
...
(
    "Tomato Spider Mites",
    "Abamectin 1.9% EC",
    "0.5ml per litre. Spray underside of leaves.",
    "Neem Oil",
    "30ml per litre. Spray every 3–5 days.",
    "Controls mites effectively.",
    "Overuse may cause resistance.",
    "Maintain humidity. Wash leaves with water spray.",
),

(
    "Tomato Yellow Leaf Curl Virus",
    "Imidacloprid 17.8% SL",
    "0.3ml per litre. Spray to control whiteflies.",
    "Neem Oil + Sticky traps",
    "Neem spray + yellow traps",
    "Controls vector insects.",
    "Virus itself cannot be cured.",
    ...
    "Grape Black Rot",
    "Mancozeb",
    "2g per litre. Spray weekly.",
    "Neem Oil",
    "30ml per litre",
    "Controls fungal growth.",
    "Needs early spraying.",
    "Prune infected parts. Improve airflow.",
),
...
(
    ...
    "Slow recovery.",
    "Avoid trunk injury. Maintain plant health.",
),
